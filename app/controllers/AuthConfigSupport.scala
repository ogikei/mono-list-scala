...
trait AuthConfigSupport extends AuthConfig {
  ...
  override def idContainer: AsyncIdContainer[String] =
    AsyncIdContainer(new TransparentIdContainer[Id])
  ...
  override def authorize(user: User, authority: Nothing)(implicit context: ExecutionContext)
  : Future[Boolean] =
    Future.successful {
      true
    }
